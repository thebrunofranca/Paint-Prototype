...
public class Quadrado  extends Figura {
    ...
    public Quadrado (Ponto p1, Ponto p2, Color cor,Color cor2) {
    ...
    public Quadrado (String s){
       ...
       StringTokenizer quebrador = new StringTokenizer(s,":");
        ...
        Color cor2 = new Color (Integer.parseInt(quebrador.nextToken()),  // R
                				Integer.parseInt(quebrador.nextToken()),  // G
                				Integer.parseInt(quebrador.nextToken()),Integer.parseInt(quebrador.nextToken())); // B
    ...
    public void torneSeVisivel (Graphics g)
    {
        ...
        g.setColor (this.cor);
        g.drawRect(p1.getX(),p1.getY(),base, base);
	Graphics2D g2d = (Graphics2D)g;
	g2d.setColor(fundo);
        g2d.fillRect(p1.getX()+1,p1.getY()+1,base-1, base-1);
    }
...
public int hashCode(){
    ...
    public Quadrado( Quadrado obj) throws NullPointerException{
        if(obj != null){
